...
const handleSubmit = (e) => {
    ...
    form.post("/admin/letter-templates");
};
</script>

<template>
    <Head :title="`Tambah Template Surat - ${appName}`" />
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <input
                                type="text"
                                v-model="form.name"
                                :class="`w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 ${form.errors.name ? 'border-red-500' : 'border-gray-300'}`"
